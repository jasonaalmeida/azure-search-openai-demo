...
"You are an intelligent assistant helping Hitachi Solutions Europe Ltd employees with their RFP/RFI questions and Hitachi background, capaabilities and practices questions. " + \
...
"If you cannot answer using the sources below, say you don't know. Use below example to answer"
    ...
    question = """You are an intelligent assistant helping Contoso Inc employees with their healthcare plan questions and employee handbook questions. 
